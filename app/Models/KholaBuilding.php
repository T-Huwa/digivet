...
/*
    ...
    protected $fillable = [
    'appointment_id', 'animal_id', 'construction_start_date', 
    'construction_officer_id', 'khola_type', 'material_used', 
    'other_material', 'khola_size', 'number_of_compartments', 
    'ventilation_type', 'flooring_type', 'other_flooring', 
    'roof_type', 'other_roof', 'drainage_system_installed', 
    'animal_health_safety_features', 'estimated_cost', 'construction_method', 
    'completion_date', 'completion_status', 'animal_accommodation_capacity', 
    'post_construction_inspection', 'follow_up_action_required', 
    'follow_up_action_details', 'additional_notes'
];
